    ...
    <main style={{ minHeight: "100vh", background: "#090820", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, color: "white", margin: "16px 0 8px" }}>Crear cuenta gratis</h1>
          <p style={{ color: "#a78bfa", fontSize: 15 }}>Empezá a generar ebooks en segundos</p>
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(112,48,239,0.3)", borderRadius: 24, padding: 36 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
            ...
            <span style={{ color: "#7a6aaa", fontSize: 13 }}>o con email</span>
            <div style={{ flex: 1, height: 1, background: "rgba(112,48,239,0.3)" }} />
          </div>
          ...
          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            style={{ width: "100%", padding: "14px", borderRadius: 14, background: "linear-gradient(135deg,#7030EF,#DB1FFF)", color: "white", fontWeight: 700, fontSize: 16, border: "none", cursor: "pointer", marginBottom: 16 }}
          >
            Crear cuenta gratis
          </button>

          <p style={{ textAlign: "center", fontSize: 12, color: "#7a6aaa" }}>
            Al registrarte aceptás los <a href="#" style={{ color: "#DB1FFF" }}>Términos de uso</a> y la <a href="#" style={{ color: "#DB1FFF" }}>Política de privacidad</a>
          </p>
        </div>

        <p style={{ textAlign: "center", marginTop: 24, color: "#7a6aaa", fontSize: 14 }}>
          ¿Ya tenés cuenta?{" "}
          <a href="/login" style={{ color: "#DB1FFF", fontWeight: 700, textDecoration: "none" }}>Iniciar sesión</a>
        </p>
